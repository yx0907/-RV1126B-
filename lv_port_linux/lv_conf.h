...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(noto_sans_font)
...
#define LV_USE_FS_POSIX 1
    ...
    #define LV_FS_POSIX_PATH "/home/elf/lvgl"         /*Set the working directory. File/directory paths will be appended to it.*/
